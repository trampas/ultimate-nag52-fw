...
ROUTINES=[('vehicle_acceleration',0x8814),('road_load',0x889c),('load_scale',0x8d72),('load_corrections',0x8ef9)]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='egs51-demand-load-') as td:
        ...
        required={0x8894,0x8934,0x8985,0x8b93,0x8c03,0x8c1a,0x8cb1,0x8d12,0x8d34,0x8d56,0x8d60,0x8d6a,
                  0x8e14,0x8e29,0x8eb0,0x8ef1,0x8f2f,0x907c,0x911b,0x912b}
        assert required<=visited,('missing branches',sorted(required-visited))
        print('PASS: 12800 persistent acceleration/load calls with selected gating and saturation paths',flush=True)
