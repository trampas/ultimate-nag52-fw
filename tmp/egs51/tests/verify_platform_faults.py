#!/usr/bin/env python3
"""Platform interlock and analog/voltage qualification parity."""
import ctypes as c
...
ROUTINES=[('starter_interlock',0x5880),('voltage_qualification',0x58e8),('analog_reference_fault',0x6312),('analog_supply_fault',0x6339)]
