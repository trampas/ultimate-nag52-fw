...
#define FOR_LIST(DO) \
    ...
    DO(LAST_FW, "LAST_FW")\
    /* -- MAP NAMES -- */ \
    DO(MAP_NAME_S_DIESEL_UPSHIFT , "S_DIESEL_UP_1")\
    DO(MAP_NAME_S_DIESEL_DOWNSHIFT , "S_DIESEL_DN_2")\
    DO(MAP_NAME_S_PETROL_UPSHIFT , "S_PETROL_UP")\
    DO(MAP_NAME_S_PETROL_DOWNSHIFT , "S_PETROL_DN_1")\
    DO(MAP_NAME_C_DIESEL_UPSHIFT , "C_DIESEL_UP_1")\
    ...
    DO(MAP_NAME_A_DIESEL_UPSHIFT , "A_DIESEL_UP_2")\
    DO(MAP_NAME_A_DIESEL_DOWNSHIFT , "A_DIESEL_DN_2")\
    ...
    DO(MAP_NAME_C_UPSHIFT_TIME , "C_UPSHIFT_T1")\
    DO(MAP_NAME_C_DOWNSHIFT_TIME , "C_DNSHIFT_T2")\
    ...
    DO(MAP_NAME_ADAPT_SHIFT_TIME, "ADP_ST_A0")\
